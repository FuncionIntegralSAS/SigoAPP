...
class _RequisitionSignatureCard extends StatefulWidget {
  ...
  const _RequisitionSignatureCard({
    super.key,
...
class _RequisitionSignatureCardState extends State<_RequisitionSignatureCard> {
  ...
  Widget _buildSignatureBadge({
    ...
    final borderColor =
        signed ? Colors.green.shade200 : Colors.orange.shade200;
  ...
  Future<void> _confirmAndRegisterExit(
      ...
      builder: (dialogCtx) => AlertDialog(
        ...
        title: const Row(
          children: [
            ...
            SizedBox(width: 8),
            Text('Confirmar Salida ERP'),
          ],
        ),
        content: Text(
          '¿Está seguro de asentar la salida definitiva en el inventario ERP para el documento ${widget.document.tipoDocumento} #${widget.document.numero}?\n\nEsta acción es irreversible y actualizará el stock oficial.',
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: const Text('Asentar Salida'),
          ),
        ],
      ),
    );
    ...
    if (success) {
        ...
        SnackBar(
          content: const Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'Salida definitiva registrada e inventario actualizado en ERP exitosamente.',
      ...
      await DialogUtils.showErrorDialog(
        context,
        title: 'Error al Asentar Salida ERP',
        message: provider.actionError ??
            'No fue posible registrar la salida definitiva en el ERP.',
  ...
  Widget build(BuildContext context) {
    ...
    final isLoadingDetail =
        provider.isDetailLoading(doc.empresa, doc.tipoDocumento, doc.numero);
    final detailError =
        provider.getDetailError(doc.empresa, doc.tipoDocumento, doc.numero);
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              bothSigned ? 'LISTA PARA ERP' : 'FIRMAS PENDIENTES',
                              style: TextStyle(
                                fontSize: 11,
                                fontWeight: FontWeight.bold,
                                color: statusColor,
