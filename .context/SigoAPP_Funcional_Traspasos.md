...
| **Activos por Responsable** | `GET` | `/api/v1/traspasos/activos` | Query: `?persona={CED}&bodega={BOD}&empresa={EMP}`<br>*(Regla: `persona` y `bodega` son obligatorios; filtra activos radicados físicamente en la bodega origen seleccionada `ACTIFIJO.ACFIBODE = :bodega`)* | `200 OK` `{ "list": [ { "articulo": "...", "placa": "...", "nombre": "...", "centroInformacion": "...", "tercero": "...", "enTramite": bool } ] }`<br>`400 Bad Request` si falta bodega o persona |
